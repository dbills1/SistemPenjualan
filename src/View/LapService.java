...
import Controller.Controller_LapService;
import com.toedter.calendar.JDateChooser;

public class LapService extends javax.swing.JFrame {

    Controller_LapService controller;
    
    public LapService() {
        initComponents();
        setLocationRelativeTo(this);
        controller = new Controller_LapService(this);
        controller.reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN SERVICE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LapService().setVisible(true);
            }
        });
    }
