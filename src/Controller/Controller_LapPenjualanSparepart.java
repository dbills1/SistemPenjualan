...
import View.LapPenjualanSparepart;
import java.io.File;
...
public class Controller_LapPenjualanSparepart {
    LapPenjualanSparepart form;
    
    public Controller_LapPenjualanSparepart(LapPenjualanSparepart form){
        this.form = form;
    }
    ...
    public void preview(){
        ...
        try{
            ...
            String path = "src/Report/LaporanPenjualanSparepart.jasper";
    ...
    public void excel(){
        ...
        try{
            Connection conn = Database.KoneksiDB();
            String path = "src/Report/LaporanPenjualanSparepart.jasper";
            File excel = new File("C:/Report/LaporanPenjualanSparepart " 
            ...
            OutputStream output = new FileOutputStream(new File("C:/Report/LaporanPenjualanSparepart " 
