...
public class Controller_LapService {
    LapService form;
    
    public Controller_LapService(LapService form){
        this.form = form;
    }
    ...
    public void preview(){
        ...
        try{
            ...
            String path = "src/Report/LaporanService.jasper";
    ...
    public void excel(){
        ...
        try{
            Connection conn = Database.KoneksiDB();
            String path = "src/Report/LaporanService.jasper";
            File excel = new File("C:/Report/LaporanService " 
            ...
            OutputStream output = new FileOutputStream(new File("C:/Report/LaporanService " 
